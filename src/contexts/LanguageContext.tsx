...
const translations: Record<Language, Record<string, string>> = {
  ...
  hi: {
    ...
    'about.p1': 'शाहीन बाघ के जीवंत हृदय में स्थित, 1मैसा कैफे दिल्ली में तुर्की और मध्य पूर्वी मिठाइयों का प्रामाणिक स्वाद लाता है। हमारा जुनून सही कुनाफा बनाना है - कुरकुरा, सुनहरा और मीठे शरबत से भरपूर।',
    ...
    'about.p3': '1मैसा में, हम गर्मजोशी से आतिथ्य और एक आरामदायक माहौल बनाने में विश्वास करते हैं जहां हर मेहमान घर जैसा महसूस करे। आइए, बैठिए और जीवन की मिठास का आनंद लीजिए।',
    ...
    // Gallery
    'gallery.title': 'गैलरी',
    'gallery.subtitle': '1मैसा की एक दृश्य यात्रा',
    'gallery.food': 'खाना',
    'gallery.vibe': 'माहौल',
